...
class _UpdateLogState extends State<UpdateLog> {
  ...
  void saveContact() async {
    ...
    for (int i = 0; i < _count; i++) {
      listedContacts.add(contentsCtrlr[i].text);
    ...
    setState(() {
      updatedLog = new Log(
          titleCtrlr.text, tagsCtrlr.text, listedContacts.reversed.toList());
    });
  ...
  void initState() {
    ...
    setState(() {
      _count = 0;
      previousLog =
          new Log(widget.logTitle, widget.logTags, widget.logContents);
